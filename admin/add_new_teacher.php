                    ...
                    <div class="col-md-12 mx-auto mt-5 mb-5">
                        <div class="card mt-5">
                            <div class="card-header">
                                <h4> <i class="fas fa-table"></i>Add New Teacher</h4>
                                <h3>
                                    <?php
                                        if (isset($_POST['btn'])){
                                            $name    = $_POST['name'];
                                            ...
                                            if ($name == ""){
                                                echo "<span class='text-danger'>Enter Name</span> <br/>";
                                            }
                                            if ($email == ""){
                                                echo "<span class='text-danger'>Enter Email Address</span> <br/>";
                                            }
                                            if ($subject == ""){
                                                echo "<span class='text-danger'>Select Subject</span> <br/>";
                                            }
                                            if ($contact == ""){
                                                echo "<span class='text-danger'>Enter Contact Number</span> <br/>";
                                            }

                                            if ($name && $email && $subject && $contact){
                                                $sql = "INSERT INTO  teachers (name, email, subject, contact, password) VALUES ('$name', '$email','$subject', '$contact', '123')";
                                                $result  = mysqli_query($connect, $sql);

                                                echo "<span class='text-success'>Teacher Add Successful</span>";
                                            }else{
                                                echo "<span class='text-danger'>Teacher Add Failed!!!</span>";
                                            }
                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="contact" placeholder="Enter contact" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <button class="btn btn-success" name="btn">Add Teacher</button>
                                    </div>
                                </form>
                            </div>
