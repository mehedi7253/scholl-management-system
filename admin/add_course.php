                        ...
                        <div class="card-body">
                                ...
                                <?php
                                    if (isset($_POST['btn'])){
                                        ...
                                        if ($course_name == ""){
										 ...
										 if ($teacher == ""){
                                            echo "<span class='text-danger'>Select Course Teacher</span><br/>";
                                        }
                            ...
                            <form action="" method="post">
                                <div class="form-group">
								 ...
								 <div class="form-group">
                                    <label>Select Course Teacher<sup> <span class="text-danger font-weight-bold">*</span> </sup></label>
                                    <select class="form-control" id="exampleFormControlSelect1" name="teacher">
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($r)){?>
                                            <option value="<?php echo $row['name'];?>"><span><?php echo $row['name'];?></span></option>
                                        <?php }?>
                                    </select>
                                </div>
                                <div class="form-group">
