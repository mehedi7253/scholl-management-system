                ...
                <div class="col-md-12 mx-auto mt-5 mb-5">
                    <div class="card mt-5">
                        <div class="card-header">
                            <h4> <i class="fas fa-table"></i> Manage Mission Visson</h4>
                        </div>
                        <div class="card-body">
                            <div class="card">
                                <div class="card-header bg-gray">
                                    <h4 class="text-center">Manage Mission</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                            ...
                                            <?php while ($row = mysqli_fetch_assoc($result)) {?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="update_mission.php?edit=<?php echo $row['id'];?>" class="btn btn-success">Update</a>
                                                        <a href="update_mission.php?del=<?php echo $row['id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete !!');">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php }?>
                                        </table>
                            ...
                            <div class="card mt-5">
                                <div class="card-header bg-info">
                                    <h4 class="text-center"> Manage Vision</h4>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <?php
                                        ...
                                        <table class="table table-bordered" id="myTable" width="100%" cellspacing="0">
                                            ...
                                            <?php while ($row = mysqli_fetch_assoc($result)) {?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="update_vission.php?edit=<?php echo $row['id'];?>" class="btn btn-success">Update</a>
                                                        <a href="update_vission.php?del=<?php echo $row['id'];?>" class="btn btn-danger" onclick="return confirm('Are you sure to delete !!');">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php }?>
                                        </table>
