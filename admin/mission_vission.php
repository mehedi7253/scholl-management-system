                ...
                <div class="col-md-12 mx-auto mt-5 mb-5">
                    <div class="card mt-5">
                        <div class="card-header">
                            <h4> <i class="fas fa-table"></i> Add Mission And Vission</h4>
                        </div>
                        <div class="card-body">
                            <div class="col-sm-12 mx-auto mt-5">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="text-center">Add Mission</h4>
                                        <h2>
                                            <?php
                                            if (isset($_POST['ms'])){
                                                ...
                                                if ($mission == ""){
                                                    echo "<span class='text-danger'>Filed Must Not Be Empty...</span> <br/>";
                                                }
                                                ...
                                                if ($mission){
                                                    ...
                                                    echo "<span class='text-success'>Mission Added Successfully</span> <br/>";
                                                    //header('Location: mission_vission.php');
                                                }else{
                                                    echo "<span class='text-danger'>Mission Added Failed....Try Again</span> <br/>";
                                                }
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                <label>Mission</label>
                                                <textarea name="mission" placeholder="Write Mission Here......." class="form-control"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <input type="submit" name="ms" class="btn btn-success" value="Add Mission">
                                            </div>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12 mx-auto mt-5">
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="text-center">Add Vision</h4>
                                        <h2>
                                            <?php
                                                if (isset($_POST['vision'])){
                                                    ...
                                                    if ($vission){
                                                        $sql = "INSERT INTO vission (vission) VALUES ('$vission')";
                                                        $res = mysqli_query($connect, $sql);

                                                        echo "<span class='text-success'>Vision Added Successfully</span> <br/>";
                                                        //header('Location: mission_vission.php');
                                                    }else{
                                                        echo "<span class='text-danger'>Vision Added Failed</span> <br/>";
                                                    }
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            <div class="form-group">
                                                <label>Vision</label>
                                                <textarea name="vission" placeholder="Write Vision Here......." class="form-control"></textarea>
                                            </div>
                                            <div class="form-group">
                                                <input type="submit" name="vision" class="btn btn-success" value="Add Vision">
                                            </div>
                                        </form>
                                    </div>
                                </div>
