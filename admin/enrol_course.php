                ...
                <div class="col-md-10 mx-auto mt-5 mb-5">
                    <div class="card mt-5">
                        <div class="card-header">
                            <h4> <i class="fas fa-table"></i> Enrol into Course</h4>
                        </div>
                        <div class="card-body">
                            <P>
                                <?php
                                    if (isset($_POST['btn'])){
                                        ...
                                        if ($course_name == ""){
                                            echo "<span class='text-danger'>Select Course Name</span><br/>";
                                        }
                                        if ($s_id == ""){
                                        ...
                                        if ($course_name && $s_id) {
                                            ...
                                            $sql = "INSERT INTO enroll_course (course_name, s_id, s_name) VALUES ('$course_name', '$s_id', '$s_name')";
                                            $res = mysqli_query($connect, $sql);

                                            echo "<span class='text-success'>Student Enrol Successfully</span><br/>";

                                        }else{
                                            echo "<span class='text-danger'>Student Enrol Failed</span><br/>";
                                        }
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="exampleFormControlSelect1" name="course_name">
                                        <?php
                                        ...
                                        <?php while ($row = mysqli_fetch_assoc($r)){?>
                                            <option value="<?php echo $row['course_name'];?>"><span><?php echo $row['course_name'];?></span></option>
                                        <?php }?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="submit" class="btn btn-success" value="Enrol Now" name="btn">
                                </div>
