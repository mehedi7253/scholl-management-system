                                ...
                                <?php if(isset($_GET['msg'])) { ?>
                                    <div class="text-center">
                                        <?php if ($_GET['msg'] == 'success') {
                                            echo "<span class='text-success font-weight-bolder'>File Uploaded Successfully!</span>";
                                        } else {
                                            echo '<span class="text-danger font-weight-bolder">Invalid File Extension!</span>';
                                        } ?>
                                    </div>
                                <?php } ?>
                            </h3>
                        ...
                        <div class="card-body">
                            <form action="store_slider.php" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>Select An Image<span class="text-danger">*</span></label>
                                    <input type="file" name="slider" class="form-control">
                                </div>
                                <div class="form-group">
                                    <input type="submit" name="slider_upload" class="btn btn-success" value="Upload">
                                </div>
                            </form>
                        </div>
