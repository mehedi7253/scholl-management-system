                ...
                <div class="col-md-12 mx-auto mt-5 mb-5">
                    <div class="card mt-5">
                        <div class="card-header">
                            <h4> <i class="fas fa-table"></i> Add New Notice</h4>
                            <h3>
                                <?php
                                if (isset($_POST['btn'])){
                                    $issue   = $_POST['issue'];
                                    ...
                                    if ($notice == ""){
                                        echo "<span class='text-danger'>Enter notice</span> <br/>";
                                    }
                                    if ($issue && $notice){
                                        $sql = "INSERT INTO  notice (issue, notice) VALUES ('$issue', '$notice')";
                                        $result  = mysqli_query($connect, $sql);

                                        echo "<span class='text-success'>Notice Add Successful</span>";
                                    }else{
                                        echo "<span class='text-danger'>Notice Add Failed!!!</span>";
                                    }
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="issue" placeholder="Enter Title" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>Notice</label>
                                ...
                                <div class="form-group">
                                    <button class="btn btn-info" name="btn">Add Notice</button>
                                </div>
                            </form>
                        </div>
